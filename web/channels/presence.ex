defmodule PhoenixStarterPack.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule PhoenixStarterPack.MyChannel do
        use PhoenixStarterPack.Web, :channel
        alias PhoenixStarterPack.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :phoenix_starter_pack,
                        pubsub_server: PhoenixStarterPack.PubSub
end
